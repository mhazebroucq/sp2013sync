    ...
    if (typeof args.startFolder !== 'undefined' && args.startFolder !== null) {
        ...
        fileDownload_1.init().then(function (files) {
            if (files === null) {
                ...
                gutil.log(gutil.colors.green(`Retrieved all elements from the folder ${options_1.startFolder} on site ${options_1.site} to local folder ${args.localFolderToPopulate}...`));
                var proms_1 = [];
